<x-filament::page>
    <div wire:ignore x-data="{
        ...
        <div class="flex flex-wrap items-center justify-end gap-4 ml-auto filament-page-actions shrink-0">
        ...
        <div x-ref="editor" class="mt-2 rounded-md ace-forge">{{ $content }}</div>
    </div>

    <x-filament::modal
        id="filament-laravel-log--clear-modal"
